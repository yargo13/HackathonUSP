$(document).ready(function() {
  var edital;
  var servico;
  var modalidade = "hackathon";
  var departamento = "poli";
  var quantidade;
  var item;
  var valor_unitario;
  var valor_total;
...
//   }
  ...
  $("#botao_like").click(function(event) {
    confirm(
      "Obrigado por contribuir com o Cronos! Gostaria de fazer outra grade?"
    );
    location.reload();
  });
  ...
  $("#botao_final").click(function(event) {
    ...
    Quantidade         Item          Valor Unitário         Valor Total 
    ${quantidade}      ${item}       ${valor_unitario}       ${valor_total}
